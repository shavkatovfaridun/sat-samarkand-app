...
const nav = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12L11.204 3.045a1.125 1.125 0 011.591 0L21.75 12M4.5 9.75V19.875c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
      </svg>
    ),
    iconFill: (
      <svg viewBox="0 0 24 24" fill="currentColor">
        <path d="M11.47 3.841a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.061l-1.106-1.1V18a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 18v-7.43l-1.107 1.1a.75.75 0 00-1.06-1.06l8.69-8.69zM10.5 18h3v-5.25a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75V18z" />
      </svg>
    ),
  },
  {
        ...
        {nav.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span
                className="text-[10px] font-medium leading-none tracking-tight transition-colors duration-150"
